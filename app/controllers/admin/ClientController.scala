...
class ClientController @Inject()(
  ...
  private def clientInformation(universityID: UniversityID)(implicit t: TimingContext): Future[ServiceResult[(SitsProfile, Option[Registration], Option[ClientSummary], Seq[(Enquiry, Seq[MessageData])], Seq[Case])]] = {
