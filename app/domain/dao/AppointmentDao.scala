...
object AppointmentDao {
  ...
  ) extends Versioned[StoredAppointment] with Created with Teamable {
  ...
  ) extends StoredVersion[StoredAppointment] with Created
  ...
  case class StoredAppointmentClient(
    ...
    created: OffsetDateTime,
    version: OffsetDateTime,
  ) extends Versioned[StoredAppointmentClient] with Created {
  ...
  case class StoredAppointmentClientVersion(
    ...
    timestamp: OffsetDateTime,
    auditUser: Option[Usercode]
  ) extends StoredVersion[StoredAppointmentClient] with Created
