...
) extends Teamable with Created[Appointment] {
...
object AppointmentOutcome extends PlayEnum[AppointmentOutcome] {
  ...
  case object EmailCounselling extends AppointmentOutcome("Email counselling")
  case object FaceToFaceCounselling extends AppointmentOutcome("Face-to-face counselling")
  case object Fitness extends AppointmentOutcome("Fitness to attend")
  case object GroupTherapy extends AppointmentOutcome("Group therapy")
  case object InHouseWorkshop extends AppointmentOutcome("In-house workshop")
  ...
  case object UniversityWorkshops extends AppointmentOutcome("University workshops")
