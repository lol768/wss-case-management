...
INSERT INTO CLIENT
SELECT DISTINCT UNIVERSITY_ID, NULL, to_timestamp('01/01/70 00:00', 'DD/MM/YY HH24:MI')
FROM USER_REGISTRATION WHERE UNIVERSITY_ID NOT IN (SELECT UNIVERSITY_ID FROM CLIENT);

ALTER TABLE USER_REGISTRATION ADD CONSTRAINT FK_USER_REGISTRATION_CLIENT FOREIGN KEY (UNIVERSITY_ID) REFERENCES CLIENT(UNIVERSITY_ID);
...
ALTER TABLE USER_REGISTRATION DROP CONSTRAINT FK_USER_REGISTRATION_CLIENT;
