...
class CasePermissionSpec extends BaseSpec with BeforeAndAfterAll {
  ...
  override protected def beforeAll(): Unit = {
    ...
    val created = caseService.create(CaseSave("Mental health assessment", None, None, CaseCause.New, Set(), Set(), Set(), Set(), None), clients, tags, Teams.MentalHealth, None, None).serviceValue
